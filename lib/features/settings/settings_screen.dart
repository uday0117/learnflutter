                  ...
                  Wrap(
                    ...
                    children: ThemeController.colorPresets.map((color) {
                      return Obx(() => GestureDetector(
                        onTap: () => themeController.updatePrimaryColor(color),
                        child: Container(
                          width: 50,
                          height: 50,
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                              color: themeController.primaryColor.value == color
                                  ? Colors.white
                                  : Colors.transparent,
                              width: 3,
                            ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Obx(() => ColorPicker(
                    ...
                    onColorChanged: (color) => themeController.updatePrimaryColor(color),
                    width: 44,
                    height: 44,
                    borderRadius: 22,
                    spacing: 8,
